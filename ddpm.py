...
class DDPMSampler:
    ...
    def __init__(self, generator: torch.Generator, num_training_steps=1000, beta_start: float = 0.00085, beta_end: float = 0.0120):
        ...
        # our initial and final beta value wont change wer jsut changing how the beta gets distributed over timesteps start out with small increases then increase more towards end and reach final beta
